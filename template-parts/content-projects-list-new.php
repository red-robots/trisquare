      ...
      $gallery_id = get_the_ID();
        ...
        <div class="inner">
          <a href="<?php echo $pagelink ?>" class="image-info" data-id="<?php echo $gallery_id ?>">
            ...
            <span class="blurred" style="background-image:url('<?php echo $main_image['sizes']['thumbnail'] ?>');"></span>
	...
	<section class="section projects-list small-thumbs cf">
		...
		<div class="wrapper">
			<div class="flexwrap">
              ...
              <span class="blurred" style="background-image:url('<?php echo $photo['sizes']['thumbnail'] ?>');"></span>
						</a>
					</div>
				</div>
				<?php } ?>
